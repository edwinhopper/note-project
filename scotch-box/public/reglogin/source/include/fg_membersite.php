...
class FGMembersite
{
 ...
 public function checkhashSSHA($salt, $password) {
    ...
    function DBLogin()
    {
       ...
       // $this->connection = new pdo($this->db_host,$this->username,$this->pwd);
	    $this->connection = mysql_connect($this->db_host,$this->username,$this->pwd);
	   // $this->connection = PDO('mysql:host=localhost;dbname=testdb;charset=utf8mb4', 'username', 'password');
	   // $this->connection = new PDO('mysql:host=$this->db_host;dbname=$this->database;charset=utf8mb4', 'username', 'pwd');
	   //    function InitDB($host,$uname,$pwd,$database,$tablename)
	   // $this->connection = new PDO('mysql:host=127.0.0.1;dbname=museum;charset=utf8mb4', 'root', 'root');
       // $this->connection = new pdo('mysql:host=$this->db_host;dbname=$this->database;charset=utf8mb4', '$this->username', '$this->pwd');
       // $this->connection = new pdo('mysql:host=127.0.0.1;dbname=museum;charset=utf8mb4', 'root', 'root');
       // $this->connection = new pdo('mysql:host=127.0.0.1;dbname=scotchbox;charset=utf8mb4',$this->username,$this->pwd);
       // $this->connection = new pdo('mysql:$this->db_host;dbname=$this->database;charset=utf8mb4',$this->username,$this->pwd);
